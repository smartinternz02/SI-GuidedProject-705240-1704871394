...
CustomKeywords.'com.qa.test.CustomFunctions.CheckDropDownListElementExist'(findTestObject('Amazon_Category_Validation_Excel_OR/Page_Amazon.com. Spend less. Smile more/CategoryElement'), 
    'Books')
